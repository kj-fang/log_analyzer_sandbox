SYS_PROMPT = """Please make a python executable , which can import any txt or log files relevant to the same folder path
And then sort out below print messages

1. pint every lines include "Successful read of table WRDS"
